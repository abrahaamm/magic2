...
def main(main_args):
    ...
    if dataset_name == 'streamspot' or dataset_name == 'wget':
        ...
        # 创建带配置信息的checkpoint路径
        checkpoint_dir = f"./checkpoints/h{main_args.num_hidden}_l{main_args.num_layers}"
        os.makedirs(checkpoint_dir, exist_ok=True)
        torch.save(model.state_dict(), f"{checkpoint_dir}/checkpoint-{dataset_name}.pt")
